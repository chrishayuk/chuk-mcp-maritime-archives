...
All modules maintain 97%+ branch coverage (349 tests across 7 test modules). Tests use
...
all eleven tool groups. Each tool module receives the MCP instance and the shared
`ArchiveManager`.
