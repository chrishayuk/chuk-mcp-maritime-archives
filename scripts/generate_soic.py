...
def build_voyages() -> list[dict]:
    ...
    voyages_raw = [
        ...
        {
            "id": 1, "ship": "Fredericus Rex Sueciae",
            "captain": "Carl Henrik Anckarhielm",
            "dep": "1732-02-09", "arr": "1733-08-27",
        ...
        # Expedition II
        {
            "id": 2, "ship": "Fredericus Rex Sueciae",
            "captain": "Carl Henrik Anckarhielm",
            "dep": "1734-01-18", "arr": "1735-06-14",
            "dest": "Canton (Guangzhou)",
        ...
        # Expedition IV
        {
            "id": 4, "ship": "Fredericus Rex Sueciae",
            "captain": "Georg Herman af Trolle",
            "dep": "1736-01-24", "arr": "1737-06-30",
            "dest": "Canton (Guangzhou)",
        ...
        # Expedition X
        {
            "id": 10, "ship": "Fredericus Rex Sueciae",
            "captain": "Georg Herman af Trolle",
            "dep": "1741-01-15", "arr": "1742-07-22",
            "dest": "Canton (Guangzhou)",
        ...
        {
            "id": 12, "ship": "Gotheborg",
            "captain": "Erik Moreen",
            "dep": "1743-03-14", "arr": "1745-09-12",
            "dest": "Canton (Guangzhou)",
        ...
        # Expedition XIII
        {
            "id": 13, "ship": "Enigheten",
            "captain": "Carl Gustaf Ekeberg",
            "dep": "1745-02-10", "arr": "1746-07-25",
            "dest": "Canton (Guangzhou)",
        ...
        # Expedition XIV
        {
            "id": 14, "ship": "Drottningen af Sverige",
            "captain": "Magnus Lagerheim",
            "dep": "1745-11-22", "arr": "1747-06-18",
            "dest": "Canton (Guangzhou)",
        ...
        # Expedition XV
        {
            "id": 15, "ship": "Fredericus Rex Sueciae",
            "captain": "Georg Herman af Trolle",
            "dep": "1746-01-12", "arr": "1747-07-30",
            "dest": "Canton (Guangzhou)",
        ...
        # Expedition XVI
        {
            "id": 16, "ship": "Adolph Friedrich",
            "captain": "Lars Bredberg",
            "dep": "1747-01-28", "arr": "1748-08-05",
            "dest": "Canton (Guangzhou)",
            "cargo": "tea, silk, and porcelain",
            "fate": "completed",
        ...
        # Expedition XVIII
        {
            "id": 18, "ship": "Prins Carl",
            "captain": "Carl Fredrik Kryger",
            "dep": "1748-10-30", "arr": "1750-06-12",
            "dest": "Canton (Guangzhou)",
        ...
        # Expedition XX
        {
            "id": 20, "ship": "Drottningen af Sverige",
            "captain": "Carl Gustaf Ekeberg",
            "dep": "1750-01-08", "arr": "1751-07-15",
            "dest": "Canton (Guangzhou)",
        ...
        # Expedition XXII
        {
            "id": 22, "ship": "Adolph Friedrich",
            "captain": "Lars Bredberg",
            "dep": "1751-01-14", "arr": "1752-07-20",
            "dest": "Canton (Guangzhou)",
        ...
        # Expedition XXIII
        {
            "id": 23, "ship": "Terra Nova",
            "captain": "Johan Ekman",
            "dep": "1752-02-06", "arr": "1753-08-10",
            "dest": "Canton (Guangzhou)",
        ...
        # Expedition XXIV
        {
            "id": 24, "ship": "Lovisa Ulrica",
            "captain": "Daniel Treutiger",
            "dep": "1753-01-22", "arr": "1754-07-18",
            "dest": "Canton (Guangzhou)",
            "cargo": "tea and porcelain",
            "fate": "completed",
        ...
        # Expedition XXV
        {
            "id": 25, "ship": "Prins Carl",
            "captain": "Carl Fredrik Kryger",
            "dep": "1753-11-10", "arr": "1755-06-22",
            "dest": "Canton (Guangzhou)",
            "cargo": "tea, silk, and porcelain",
            "fate": "completed",
        ...
        # Expedition XXVI
        {
            "id": 26, "ship": "Enigheten",
            "captain": "Olof Swinhufvud",
            "dep": "1754-01-20", "arr": "1755-08-02",
            "dest": "Canton (Guangzhou)",
            "cargo": "tea (bohea and hyson), porcelain services",
            "fate": "completed",
        ...
        # Expedition XXVII
        {
            "id": 27, "ship": "Oster-Gothland",
            "captain": "Erik Nyberg",
            "dep": "1755-02-14", "arr": "1756-08-10",
            "dest": "Canton (Guangzhou)",
            "cargo": "tea, porcelain, and silk brocade",
            "fate": "completed",
        ...
        {
            "id": 28, "ship": "Lovisa Ulrica",
            "captain": "Daniel Treutiger",
            "dep": "1756-01-08", "arr": None,
            "dest": "Canton (Guangzhou)",
        ...
        # Expedition XXIX
        {
            "id": 29, "ship": "Adolph Friedrich",
            "captain": "Christian Braad",
            "dep": "1756-11-18", "arr": "1758-06-30",
            "dest": "Canton (Guangzhou)",
            "cargo": "tea, spices, and porcelain",
            "fate": "completed",
        ...
        # Expedition XXX
        {
            "id": 30, "ship": "Stockholm",
            "captain": "Carl Gustaf Ekeberg",
            "dep": "1757-01-25", "arr": "1758-08-12",
            "dest": "Canton (Guangzhou)",
            "cargo": "tea (congou and pekoe), rhubarb, and silk",
            "fate": "completed",
        ...
        # Expedition XXXI
        {
            "id": 31, "ship": "Kronprinsen",
            "captain": "Gustaf Adolf Arfvidsson",
            "dep": "1758-02-08", "arr": "1759-07-22",
            "dest": "Canton (Guangzhou)",
        ...
        # Expedition XXXII
        {
            "id": 32, "ship": "Terra Nova",
            "captain": "Johan Ekman",
            "dep": "1758-12-03", "arr": "1760-06-14",
            "dest": "Canton (Guangzhou)",
        ...
        {
            "id": 33, "ship": "Drottningen af Sverige",
            "captain": "Samuel Wennergren",
            "dep": "1759-01-10", "arr": None,
            "dest": "Canton (Guangzhou)",
        ...
        # Expedition XXXIV
        {
            "id": 34, "ship": "Prins Carl",
            "captain": "Carl Fredrik Kryger",
            "dep": "1760-01-22", "arr": "1761-07-28",
            "dest": "Canton (Guangzhou)",
            "cargo": "tea (bohea), porcelain, and silk",
            "fate": "completed",
        ...
        # Expedition XXXV
        {
            "id": 35, "ship": "Oster-Gothland",
            "captain": "Erik Nyberg",
            "dep": "1761-02-14", "arr": "1762-08-18",
            "dest": "Canton (Guangzhou)",
        ...
        {
            "id": 36, "ship": "Stockholm",
            "captain": "Carl Gustaf Ekeberg",
            "dep": "1762-01-10", "arr": "1763-07-14",
            "dest": "Canton (Guangzhou)",
            "cargo": "tea, silk, and porcelain",
            "fate": "completed",
        ...
        # Expedition XXXVII
        {
            "id": 37, "ship": "Stockholm",
            "captain": "Carl Gustaf Ekeberg",
            "dep": "1766-02-18", "arr": "1767-07-30",
            "dest": "Canton (Guangzhou)",
        ...
        # Expedition XXXVIII
        {
            "id": 38, "ship": "Sophia Magdalena",
            "captain": "Jacob Hahr",
            "dep": "1766-11-05", "arr": "1768-06-22",
            "dest": "Canton (Guangzhou)",
            "cargo": "tea and porcelain",
            "fate": "completed",
        ...
        # Expedition XXXIX
        {
            "id": 39, "ship": "Konung Gustaf",
            "captain": "Anders Gotheen",
            "dep": "1768-01-15", "arr": "1769-07-08",
            "dest": "Canton (Guangzhou)",
        ...
        # Expedition XL
        {
            "id": 40, "ship": "Adolph Friedrich",
            "captain": "Christian Braad",
            "dep": "1768-11-22", "arr": "1770-06-15",
            "dest": "Canton (Guangzhou)",
            "cargo": "tea, arrack, and silk",
            "fate": "completed",
        ...
        # Expedition XLI
        {
            "id": 41, "ship": "Prins Carl",
            "captain": "Jakob Wallenberg",
            "dep": "1769-12-05", "arr": "1771-07-10",
            "dest": "Canton (Guangzhou)",
            "cargo": "tea (bulk hyson), porcelain, and silk",
            "fate": "completed",
        ...
        # Expedition XLIII
        {
            "id": 43, "ship": "Sophia Magdalena",
            "captain": "Jacob Hahr",
            "dep": "1770-01-18", "arr": "1771-08-02",
            "dest": "Canton (Guangzhou)",
            "cargo": "tea, porcelain dinner services, and silk brocade",
            "fate": "completed",
        ...
        # Expedition XLIV
        {
            "id": 44, "ship": "Cron-Prinsen Gustaf",
            "captain": "Lars Hjorth",
            "dep": "1770-11-28", "arr": "1772-06-18",
            "dest": "Canton (Guangzhou)",
            "cargo": "tea, silk, and porcelain",
            "fate": "completed",
        ...
        # Expedition XLV
        {
            "id": 45, "ship": "Konung Gustaf",
            "captain": "Anders Gotheen",
            "dep": "1771-11-10", "arr": "1773-06-25",
            "dest": "Canton (Guangzhou)",
            "cargo": "tea (bohea and congou), porcelain, lacquerware",
            "fate": "completed",
        ...
        # Expedition XLVI
        {
            "id": 46, "ship": "Gustaf III",
            "captain": "Carl Reinhold Tersmeden",
            "dep": "1773-02-05", "arr": "1774-08-12",
            "dest": "Canton (Guangzhou)",
        ...
        {
            "id": 47, "ship": "Enigheten",
            "captain": "Erik Nyberg",
            "dep": "1773-11-20", "arr": None,
            "dest": "Canton (Guangzhou)",
            "cargo": "tea (intended cargo)",
            "fate": "wrecked",
        ...
        # Expedition XLVIII
        {
            "id": 48, "ship": "Sophia Albertina",
            "captain": "Peter Hegardt",
            "dep": "1774-01-16", "arr": "1775-07-22",
            "dest": "Canton (Guangzhou)",
            "cargo": "tea (hyson), sugar candy, and porcelain",
            "fate": "completed",
        ...
        # Expedition XLIX
        {
            "id": 49, "ship": "Riksens Stander",
            "captain": "Abraham Falander",
            "dep": "1775-02-10", "arr": "1776-08-18",
            "dest": "Canton (Guangzhou)",
            "cargo": "tea, silk, and porcelain",
            "fate": "completed",
        ...
        # Expedition L
        {
            "id": 50, "ship": "Gustaf III",
            "captain": "Carl Reinhold Tersmeden",
            "dep": "1776-01-08", "arr": "1777-07-14",
            "dest": "Canton (Guangzhou)",
        ...
        # Expedition LI
        {
            "id": 51, "ship": "Konung Gustaf",
            "captain": "Nils Wahlberg",
            "dep": "1777-01-22", "arr": "1778-07-30",
            "dest": "Canton (Guangzhou)",
            "cargo": "tea, porcelain, and lacquered cabinets",
            "fate": "completed",
        ...
        {
            "id": 52, "ship": "Sophia Albertina",
            "captain": "Peter Hegardt",
            "dep": "1778-02-10", "arr": None,
            "dest": "Canton (Guangzhou)",
            "cargo": "tea (intended cargo)",
            "fate": "captured",
        ...
        # Expedition LIII
        {
            "id": 53, "ship": "Riksens Stander",
            "captain": "Abraham Falander",
            "dep": "1778-11-15", "arr": "1780-06-28",
            "dest": "Canton (Guangzhou)",
            "cargo": "tea, silk, and spices",
            "fate": "completed",
        ...
        # Expedition LIV
        {
            "id": 54, "ship": "Gustaf III",
            "captain": "Carl Reinhold Tersmeden",
            "dep": "1780-01-12", "arr": "1781-07-20",
            "dest": "Canton (Guangzhou)",
        ...
        {
            "id": 55, "ship": "Cron-Prinsen Gustaf",
            "captain": "Lars Hjorth",
            "dep": "1780-11-22", "arr": None,
            "dest": "Canton (Guangzhou)",
            "cargo": "tea (intended cargo)",
            "fate": "wrecked",
        ...
        # Expedition LVI
        {
            "id": 56, "ship": "Sophia Magdalena",
            "captain": "Jacob Hahr",
            "dep": "1781-02-04", "arr": "1782-08-10",
            "dest": "Canton (Guangzhou)",
        ...
        # Expedition LVII
        {
            "id": 57, "ship": "Konung Gustaf",
            "captain": "Johan Gadd",
            "dep": "1782-01-18", "arr": "1783-07-25",
            "dest": "Canton (Guangzhou)",
            "cargo": "tea, silk, and porcelain",
            "fate": "completed",
        ...
        # Expedition LVIII
        {
            "id": 58, "ship": "Gustaf III",
            "captain": "Nils Wahlberg",
            "dep": "1783-01-10", "arr": "1784-07-16",
            "dest": "Canton (Guangzhou)",
            "cargo": "tea (congou and pekoe), rhubarb, and silk",
            "fate": "completed",
        ...
        # Expedition LIX
        {
            "id": 59, "ship": "Riksens Stander",
            "captain": "Abraham Falander",
            "dep": "1784-02-06", "arr": "1785-08-12",
            "dest": "Canton (Guangzhou)",
            "cargo": "tea, porcelain, and silk",
            "fate": "completed",
        ...
        {
            "id": 60, "ship": "Prins Carl",
            "captain": "Erik Moreen (junior)",
            "dep": "1784-11-20", "arr": None,
            "dest": "Canton (Guangzhou)",
            "cargo": "tea, silk, and porcelain",
            "fate": "wrecked",
        ...
        # Expedition LXII
        {
            "id": 62, "ship": "Gustaf III",
            "captain": "Carl Reinhold Tersmeden",
            "dep": "1787-02-08", "arr": "1788-08-05",
            "dest": "Canton (Guangzhou)",
        ...
        {
            "id": 63, "ship": "Sophia Magdalena",
            "captain": "Jacob Hahr",
            "dep": "1788-11-15", "arr": None,
            "dest": "Canton (Guangzhou)",
            "cargo": "tea (intended cargo)",
            "fate": "captured",
        ...
        # Expedition LXIV
        {
            "id": 64, "ship": "Norrkoeping",
            "captain": "Anders Gotheen",
            "dep": "1789-01-20", "arr": "1790-07-25",
            "dest": "Canton (Guangzhou)",
            "cargo": "tea, silk, and porcelain",
            "fate": "completed",
        ...
        # Expedition LXV
        {
            "id": 65, "ship": "Riksens Stander",
            "captain": "Nils Wahlberg",
            "dep": "1790-02-10", "arr": "1791-08-08",
            "dest": "Canton (Guangzhou)",
            "cargo": "tea, porcelain, and silk brocade",
            "fate": "completed",
        ...
        # Expedition LXVI
        {
            "id": 66, "ship": "Gustaf III",
            "captain": "Johan Gadd",
            "dep": "1791-01-15", "arr": "1792-07-18",
            "dest": "Canton (Guangzhou)",
        ...
        {
            "id": 68, "ship": "Norrkoeping",
            "captain": "Anders Gotheen",
            "dep": "1793-11-22", "arr": None,
            "dest": "Canton (Guangzhou)",
            "cargo": "tea (intended cargo)",
            "fate": "wrecked",
        ...
        # Expedition LXIX
        {
            "id": 69, "ship": "Riksens Stander",
            "captain": "Abraham Falander",
            "dep": "1794-01-20", "arr": "1795-07-30",
            "dest": "Canton (Guangzhou)",
        ...
        # Expedition LXX
        {
            "id": 70, "ship": "Gustaf III",
            "captain": "Nils Wahlberg",
            "dep": "1795-02-08", "arr": "1796-08-10",
            "dest": "Canton (Guangzhou)",
            "cargo": "tea, silk, and porcelain",
            "fate": "completed",
        ...
        {
            "id": 72, "ship": "Gustaf III",
            "captain": "Nils Wahlberg",
            "dep": "1798-01-10", "arr": None,
            "dest": "Canton (Guangzhou)",
            "cargo": "tea (intended cargo)",
            "fate": "captured",
        ...
        # Expedition LXXIII
        {
            "id": 73, "ship": "Riksens Stander",
            "captain": "Abraham Falander",
            "dep": "1799-02-05", "arr": "1800-08-15",
            "dest": "Canton (Guangzhou)",
            "cargo": "tea, silk, and porcelain",
            "fate": "completed",
        ...
        {
            "id": 75, "ship": "Riksens Stander",
            "captain": "Nils Wahlberg",
            "dep": "1801-11-20", "arr": None,
            "dest": "Canton (Guangzhou)",
            "cargo": "tea (intended cargo)",
            "fate": "captured",
        ...
        {
            "id": 77, "ship": "Norrkoeping",
            "captain": "Anders Gotheen",
            "dep": "1805-01-15", "arr": None,
            "dest": "Canton (Guangzhou)",
            "cargo": "tea, silk, and porcelain",
            "fate": "wrecked",
